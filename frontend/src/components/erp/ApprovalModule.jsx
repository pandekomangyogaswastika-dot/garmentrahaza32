        ...
        <div className="flex gap-1">
          {['Pending', 'Approved', 'Rejected', ''].map(status => (
            <button
              ...
              className={`px-3 py-1.5 rounded-lg text-sm border ${filterStatus === status ? 'bg-teal-600 text-white border-teal-600' : 'border-border text-muted-foreground hover:bg-[var(--glass-bg)]'}`}
          ...
          <div className="space-y-5" data-testid="approval-detail-modal">
            ...
            <div className="border-t border-border pt-3">
              ...
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 bg-primary text-white rounded-lg text-xs hover:brightness-110"
