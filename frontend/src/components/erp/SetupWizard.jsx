...
const STEP_META = [
  ...
  },
  {
    ...
    description:
      'Urutan proses: Rajut → Linking → Sewing → Steam → QC → Packing, plus rework tunggal. Sudah di-seed otomatis; biasanya tidak perlu diubah kecuali pabrik Anda punya proses khusus.',
